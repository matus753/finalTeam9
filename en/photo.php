            ...
            <div class="col-lg-12">
                ...
                <div>
                    ...
                    for($i = 0; $i < sizeof($pom); $i++) {
                        ...
                        echo '<a class="image-link" href="../images/photoGallery/Normal/'.$folder.'/'.$image.'" data-lightbox="'.$folder.'" data-title="'.$titleEN.'"><img class="small image" src="../images/photoGallery/Normal/'.$folder.'/'.$image.'" alt=""/></a>';
                        if ($i == sizeof($pom)-1) {
                            echo '</div>';
