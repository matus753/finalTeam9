...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
		...
		<link rel="stylesheet" href="<?php echo e(URL::asset('css/eb_general.css')); ?>">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand navbar-brand-logo" href="<?php echo e(url('/')); ?>">
                    <div class="logo">
                        <img id="logoIMG" src="<?php echo e(URL::asset('images/logo/logo_skratkove_transparentne_na_modre_pozadie.png')); ?>" width="167" alt="logo">
                    </div>
                </a>
            </div>
                ...
                <ul class="nav navbar-nav navbar-right scrollable-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(url('/about#history')); ?>" id="navSec1" class="navbarItem sectItem">História</a></li>
                            <li><a href="<?php echo e(url('/about#hoi')); ?>" id="navSec2" class="navbarItem sectItem">Vedenie ústavu</a></li>
                            <li class="dropdown-submenu dropdown">
                                <a href="<?php echo e(url('/about#departments')); ?>" class="dropdown-toggle navbarItem" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Oddelenia <b class="caret"></b></a>
                                <ul class="dropdown-menu submenuItem3" >
                                    <li><a href="<?php echo e(url('/about#department1')); ?>" id="navSec31" class="sectItem">Oddelenie aplikovanej mechaniky a mechatroniky (OAMM)</a></li>
                                    <li><a href="<?php echo e(url('/about#department2')); ?>" id="navSec32" class="sectItem">Oddelenie informačných, komunikačných a riadiacich systémov (OIKR)</a></li>
                                    <li><a href="<?php echo e(url('/about#department3')); ?>" id="navSec33" class="sectItem">Oddelenie elektroniky, mikropočítačov a PLC systémov (OEMP)</a></li>
                                    <li><a href="<?php echo e(url('/about#department4')); ?>" id="navSec34" class="sectItem">Oddelenie E-mobility, automatizácie a pohonov (OEAP)</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a href="<?php echo e(url('/staff')); ?>" class="navbarItem">Pracovníci</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle navbarItem" data-toggle="dropdown">Štúdium <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="<?php echo e(url('/study#section1')); ?>" class="navbarItem sectItemS">  Pre uchádzačov o štúdium</a></li>
                            <li><a href="<?php echo e(url('/study#section2')); ?>" class="navbarItem sectItemS">  Bakalárske štúdium</a></li>
                            <li><a href="<?php echo e(url('/study#section3')); ?>" class="navbarItem sectItemS">  Inžinierske štúdium</a></li>
                            <li><a href="<?php echo e(url('/study#section4')); ?>" class="navbarItem sectItemS">  Doktorandské štúdium</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu multi-level">
                            <li><a href="<?php echo e(url('/projects')); ?>" class="navbarItem">Projekty</a></li>
                            <li class="dropdown-submenu dropdown">
                                ...
                                <ul class="dropdown-menu submenuItem">
                                    <li><a href="<?php echo e(url('/ekart')); ?>" >Elektrická motokára</a></li>
                                    <li><a href="<?php echo e(url('/autonom-vehicle')); ?>" >Autonómne vozidlo 6×6</a></li>
                                    <li><a href="<?php echo e(url('/led-cube')); ?>" >3D LED kocka</a></li>
                                    <li><a href="<?php echo e(url('/biomechatronic')); ?>" >Biomechatronika</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu multi-level">
                            <li><a href="<?php echo e(url('/photos')); ?>" class="navbarItem">Fotogaléria</a></li>
                            <li><a href="<?php echo e(url('/videos')); ?>" class="navbarItem">Videá</a></li>
                            <li><a href="<?php echo e(url('/media')); ?>" class="navbarItem">Média</a></li>
                    ...
                    <li><a href="<?php echo e(url('/contact')); ?>" class="navbarItem">Kontakt</a></li>
