                    ...
                    <table id="news-table" class="table table-stripped table-bordered intranet-table">
                        ...
                        <tbody>
                            ...
                            <tr class="{{$n->exp}}">
                                ...
                                <td class="pCol4">
                                    <a href="{{ url('/news-admin-edit/'.$n->n_id) }}" class="btn btn-success btn-sm" ><span class="fa fa-pencil-square-o "></span></a>
                                    <a href="javascript:void(0)" onclick="confirmation_redirect('Potvrdenie','Naozaj chcete zmazať tento záznam? {{ $n->title_sk }} ', '{{ url('/news-admin-delete/'.$n->n_id) }}' )" class="btn btn-danger btn-sm" ><span class="fa fa-trash-o "></span></a>
                                </td> 
                            </tr>   
                            @endforeach
                        </tbody>
