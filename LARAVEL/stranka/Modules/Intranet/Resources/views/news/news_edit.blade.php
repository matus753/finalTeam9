...
$(document).ready(function(){
    ...
    var p_sk = {{ 1024 - strlen($item->preview_sk) }};
    $('#skc').text(p_sk);
    ...
    var p_en = {{ 1024 - strlen($item->preview_en) }};
    $('#ske').text(p_en);
            ...
            <form name="projectForm"  action="{{ url('/news-admin-edit-action/'.$item->n_id) }}" method="post" enctype="multipart/form-data" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 col-md-offset-1">
                        ...
                        <img src="{{ get_news_image($item->hash_id, $item->image_hash_name) }}" class="img-responsive" alt="news_image" width="100">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="sk-editor" name="editor_content_sk">{{ $item->editor_content_sk }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="en-editor">Dlhý text EN:</label>
                            <textarea class="form-control" id="en-editor" name="editor_content_en">{{ $item->editor_content_en }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @foreach($add_files as $added)
                                <div class="row" style="margin-right: 0; margin-bottom: 10px;">
                                    <div class="col-md-10" style="margin-top: 8px;">{{ $added->file_name }}</div>
                                    <div class="col-md-1 col-md-offset-1">
                                        <a class=" btn btn-danger" href="{{ url('/news-admin-delete-added/'.$added->nf_id.'/'.$item->n_id) }}">Odstrániť</a>
                                    </div>
                                </div>
                                <hr>
                            @endforeach
