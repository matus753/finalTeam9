                        ...
                        @foreach($subjects as $key => $subject)
                            <tr style="background-color: #f5f5f5">
                                ...
                                <th class="col-md-2 text-center">
                                    ...
                                    <a title="Delete" href="javascript:void(0)" onclick="confirmation_redirect('Potvrdenie','Naozaj chcete zmazať tento záznam? {{ $subject->title }} ', '{{ url('/subjects-admin-delete/'.$subject->sub_id) }}' )" class="btn btn-danger btn-sm" ><span class="fa fa-trash-o "></span></a>
                                </th>
                            </tr>
