            ...
            <div class="btn-group">
                <div class="dropdown pull-left" style="margin-right: 1em;">
                    ...
                    <li><a href="{{ url('/schedule-admin-subject') }}">Rozvrhy predmetov</a></li>
                        <li><a href="#">Rozrvhy učiteľov</a></li>
                        <li><a href="#">Rozvrhy miestností</a></li>
                        <li><a href="#">Rozvrhy dňa v týždni</a></li>
                        <li><a href="#">Rozvrhy oddelení</a></li>
            ...
            <div class="btn-group">
                <div class="dropdown pull-left" style="margin-right: 1em;">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ url('/schedule-admin-rooms') }}">Miestnosti</a></li>
        ...
        <div class="intra-div">
            <form class="form-horizontal" method="GET" action="{{ url('/schedule-admin-subject') }}">
                ...
                <div class="form-group">
                    ...
                    @if(has_permission('admin'))
                    <div class="col-md-1">
                        <button type="submit" name="edit" class="btn btn-primary">Uprav</button>
                    </div>
                    @endif
                    <div class="col-md-3">
                        <div class="checkbox">
