...
--
-- Hostiteľ: localhost
-- Čas generovania: St 28.Feb 2018, 10:26
-- Verzia serveru: 10.0.33-MariaDB-0ubuntu0.16.04.1
...
INSERT INTO `events` (`e_id`, `name_sk`, `name_en`, `text_sk`, `text_en`, `url`, `place`, `image`, `date`, `time`) VALUES
(2, 'fasdfasd', 'fasdfasdfasdfasdf', 'fdfasdfasfdasfsa', 'dfasdfsadfs', 'http://www.google.com', 'fasdfasdfsad', 'UNjyn0YN5GvSy5A4ByBeasCFUodQ5vh64SpwJkXC.jpeg', 1519801728, '15:45');
