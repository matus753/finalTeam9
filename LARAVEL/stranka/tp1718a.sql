...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: St 11.Apr 2018, 12:20
...
(2, 'ŠZS pre inžinierske štúdium', 'ŠZS for engineering studies', NULL, NULL, NULL, NULL, 1528761600, NULL),
(3, 'ŠZS pre inžinierske štúdium', 'ŠZS for engineering studies', NULL, NULL, NULL, NULL, 1528848000, NULL),
(4, 'ŠZS pre bakalárske štúdium', 'ŠZS for bachelor study', NULL, NULL, NULL, NULL, 1530576000, NULL),
(5, 'Istrobot', 'Istrobot', NULL, NULL, NULL, NULL, 1523664000, NULL),
(6, 'ŠVOČ', 'ŠVOČ', NULL, NULL, NULL, NULL, 1524009600, NULL),
(7, 'Začiatok akademického roka 2018/2019', 'Beginning of academic year', NULL, NULL, NULL, NULL, 1537142400, NULL),
(8, 'Učí sa ako utorok', 'Learns like Tuesday', NULL, NULL, NULL, NULL, 1525910400, NULL),
(9, 'Promócie absolventov inžinierskeho štúdia', 'Graduates of engineering studies', NULL, NULL, NULL, 'ÚAMT', 1531267200, '9:00'),
(10, 'Termín podania prihlášky na bakalárske štúdium', 'Application deadline for bachelor study', NULL, NULL, NULL, NULL, 1525046400, NULL),
(11, 'Zasadnutie prijímacej komisie pre bakalárske štúdium', 'Meeting of the admission committee for bachelor study', NULL, NULL, NULL, NULL, 1529280000, NULL),
(12, 'Termín podania prihlášky na inžinierske štúdium', 'The deadline for submitting the application for engineering studies', NULL, NULL, NULL, NULL, 1527724800, NULL),
(13, 'Prijímacia skúška pre inžinierske štúdium', 'Admission exam for engineering study', NULL, NULL, NULL, NULL, 1529971200, NULL),
(14, 'Prijímacia skúška pre inžinierske štúdium', 'Admission exam for engineering study', NULL, NULL, NULL, NULL, 1530057600, NULL),
(15, 'Prijímacia skúška pre inžinierske štúdium', 'Admission exam for engineering study', NULL, NULL, NULL, NULL, 1530144000, NULL),
(16, 'Zasadnutie prijímacej komisie pre inžinierske štúdium', 'Meeting of the admission committee for engineering studies', NULL, NULL, NULL, NULL, 1531440000, NULL),
(17, 'Prijímacia skúška pre doktorandské štúdium', 'Admission exam for doctoral study', NULL, NULL, NULL, NULL, 1530057600, NULL),
(18, 'Termín podania prihlášky na doktorandské štúdium', 'The date of application for doctoral study', NULL, NULL, NULL, NULL, 1527724800, NULL),
(19, 'Zasadnutie prijímacej komisie pre doktorandské štúdium', 'Meeting of the admission committee for doctoral study', NULL, NULL, NULL, NULL, 1530662400, NULL),
(20, 'Elitech', 'Elitech', '20. konferencia doktorandov', '20th conference of PhD students', NULL, NULL, 1527033600, NULL);
...
(1, 6, 'sarm201546.pdf', 'szMtf65ccdBXhGifSQpXTE32hUhY3CA4SUw4l4Dm.pdf');
...
(1, 'Vladislav', 'Bača', 'Ing.', NULL, NULL, 'baca.jpg', 'T005', '264', 'OEMP', 'doktorand', '', '', '', 0),
...
(7, 'Dmitrii', 'Borkin', 'Ing.', NULL, NULL, NULL, 'D 102', '395', 'OIKR', 'doktorand', '', '', '', 0),
...
(11, 'František', 'Erdödy', NULL, NULL, NULL, 'erdody.jpg', 'A S39', '818', 'AHU', 'teacher', '', '', '', 0),
...
(18, 'Juraj', 'Hrabovský', 'Ing.', ' PhD.', NULL, NULL, 'A 706', '559', 'OAMM', 'teacher', '', '', '', 0),
...
(22, 'Jakub', 'Jakubec', 'Ing.', ' PhD.', NULL, NULL, 'A 707', '452', 'OAMM ', 'researcher', '', '', '', 0),
...
(27, 'Štefan', 'Kozák', 'prof. Ing.', 'PhD.', NULL, 'default_male_img.png', 'D 115', '281', 'OEMP', 'teacher', '[]', NULL, NULL, 0),
...
(42, 'Admin', 'Admin', NULL, NULL, 'xdzacovsky', NULL, '', NULL, '', '', '', '', '', 0),
...
INSERT INTO `subjects` (`sub_id`, `abbrev`, `title`, `title_en`, `hash_name`) VALUES
(1, 'I-ASRAV', 'Automatizované systémy riadenia automobilových výrob', 'Automatic Control Systems in Car Production', '0c923a6d87fddabcd4f5cb5b2f3a58b2'),
(2, 'I-AMS', 'Autonómne mechatronické systémy', 'Autonomous Mechatronic Systems', '157f9ba36dd25159c9829cd1f12ebb36'),
(3, 'I-CSPMS', 'CAD  systémy a projektovanie mechatronických systémov', 'CAD and Mechatronics Systems Design', 'b723af648c5a822be03eec592673651d'),
(4, 'I-CAEMS', 'CAE mechatronických systémov', 'CAE of Mechatronic Systems', ''),
(5, 'B-DAVIS', 'Databázové a vizualizačné systémy', 'Database and Visualization Systems', ''),
(6, 'B-DYMES', 'Dynamika mechatronických systémov', 'Dynamics of Mechatronic Systems', ''),
(7, 'B-ELSA', 'Elektronické systémy automobilov', 'Automotive Electronic Systems', ''),
(8, 'B-KSS', 'Komunikačné systémy a siete', 'Communication Systems and Networks', ''),
(9, 'B-MECH', 'Mechanika', 'Mechanics', ''),
(10, 'B-MSBEZ', 'Mechatronické systémy bezpečnosti automobilov a elektromobilov', 'Safety Mechatronic Systems of Automobiles and Electromobiles', ''),
(11, 'I-MEMSISA', 'MEMS - inteligentné senzory a aktuátory', 'MEMS - Intelligent Sensors and Actuators', ''),
(12, 'I-MKP', 'Metóda konečných prvkov', 'Finite Element Method', ''),
(13, 'I-MCR', 'Metódy číslicového riadenia', 'Digital Control Methods', ''),
(14, 'I-MVI', 'Metódy vypočtovej inteligencie', 'Soft Computing Methods in Mechatronics', ''),
(15, 'B-MIPS', 'Mikropočítačové systémy', 'Microcomputer Systems', ''),
(16, 'I-MRNMS', 'Modelovanie a riadenie nelineárnych mechatronických systémov', 'Modelling and Control of Nonlinear Mechatronic Systems', ''),
(17, 'B-MSLAB', 'Modelovanie a simulácia v prostredí Matlab', 'Modeling and Simulation Using Matlab', ''),
(18, 'I-MPM', 'Multifyzikálne procesy v mechatronike', 'Multiphysical Processes in Mechatronics', ''),
(19, 'I-MTMP', 'Multimédiá a telematika pre mobilné platformy', 'Multimedia and Telematics for Mobile Platforms', ''),
(20, 'B-NAVEZ', 'Návrh elektronických zariadení', 'Design of Electronic Systems', ''),
(21, 'I-NPAE', 'Nekonvenčné pohony automobilov a elektromobilov', 'Nonconventional Automotive and Electromobile Drives', ''),
(22, 'I-OPM', 'Optimalizácia procesov v mechatronike', 'Optimization in Mechatronics', ''),
(23, 'I-OSA', 'Osvetlovacie systémy automobilov', 'Automotive Lighting Systems', ''),
(24, 'B-PLCM', 'PLC systémy v mechatronike', 'PLC Systems in Mechatronics', ''),
(25, 'I-PHSMA', 'Pneumatické a hydraulické systémy v mechatronických aplikáciách', 'Pneumatic and Hydraulic Systems in Mechatronic Applications', ''),
(26, 'I-PSZE', 'Pohonné systémy  a zdroje v elektromobiloch', 'Powertrain Systems and Energy Sources of Electric Vehicles', ''),
(27, 'I-PMRMS', 'Pokročilé metódy riadenia mechatronických systémov', 'Advanced Control Methods for Mechatronic Systems', ''),
(28, 'B-PROPA', 'Procesy pohybu automobilov', 'Dynamics of Vehicles', ''),
(29, 'B-PASME', 'Prvky a systémy v mechatronike', 'Components and Systems in Mechatronics', ''),
(30, 'B-SENSAK', 'Senzorové systémy a aktuátory', 'Sensor Systems and Actuators', ''),
(31, 'I-SMA', 'Servopohony pre mechatronické aplikácie', 'Servosystems for Mechatronic Applications', ''),
(32, 'B-SMS', 'Smart mechatronické systémy', 'Smart Mechatronic Systems', ''),
(33, 'B-SAEMOB', 'Stavba automobilov a elektromobilov', 'Design of Automobiles and Electromobiles', ''),
(34, 'B-SAR1', 'Systémy automatického riadenia 1', 'Automatic Control Systems 1', ''),
(35, 'B-SAR2', 'Systémy automatického riadenia 2', 'Automatic Control Systems 2', ''),
(36, 'I-TDIAG', 'Technická diagnostika', 'Technical Diagnostics', ''),
(37, 'I-TSAE', 'Transmisné systémy automobilov a elektromobilov', 'Automotive and Electromobile Transmission Systems', ''),
(38, 'B-UIE', 'Úvod do inžinierstva', 'Introduction into Engineering', ''),
(39, 'B-VIPROT', 'Virtuálne prototypovanie', 'Virtual Prototyping', ''),
(40, 'I-VPPMS', 'Vývojové programové prostredia  pre mechatronické systémy', 'Development Programming Environment for Mechatronic Systems', ''),
(41, 'B-WEBTE1', 'Webové technológie 1', 'Web Technologies 1', ''),
(42, 'B-WEBTE2', 'Webové technológie 2', 'Web Technologies 2', ''),
(43, 'B-DTV', 'Digitálne technológie výroby', 'Digital Production Technologies', ''),
(44, 'B-TINA', 'Tvorba internetových aplikácií', 'Design of Web Applications', ''),
(45, 'B-ZPOC', 'Základy počítačov', 'Introduction to Computers', ''),
(46, 'I-IMS', 'Inteligentné mechatronické systémy', 'Smart Mechatronic Systems', ''),
(47, 'I-POIT', 'Pokročilé informačné technológie', 'Advanced Information Technologies', ''),
(48, 'I-VKARM', 'Vybrané kapitoly z automatického riadenia pre mechatroniku', 'Selected Topics from Automatic Control for Mechatronics', ''),
(49, 'I-VMSM', 'Vnorené mikropočítačové systémy v mechatronike ', 'Embedded Microcontrollers Systems in Mechatronics', '');
