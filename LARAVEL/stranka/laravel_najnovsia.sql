...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: Ne 11.Feb 2018, 16:15
...
INSERT INTO `staff` (`id`, `name`, `surname`, `title1`, `title2`, `ldapLogin`, `photo`, `room`, `phone`, `department`, `staffRole`, `function`, `roles`, `email`, `web`) VALUES
...
(3, 'Richard', 'Balogh', 'Ing.', ' PhD.', NULL, 'balogh.jpg', 'D110', '411', 'OEMP', 'teacher', 'zástupca vedúceho oddelenia', '', '', ''),
...
(37, 'Tibor', 'Sedlár', 'Ing. ', NULL, NULL, NULL, 'A 803', '399', 'OAMM', 'teacher', NULL, '', '', ''),
(38, 'Erich', 'Stark', 'Ing.', NULL, NULL, 'stark.jpg', 'C 014', '', 'OIKR', 'doktorand', NULL, '', '', ''),
(39, 'Peter', 'Ťapák', 'Ing.', ' PhD.', NULL, NULL, 'D 121', '569', 'OEAP', 'teacher', NULL, '', '', ''),
(40, 'Katarína', 'Žáková', 'doc. Ing.', ' PhD.', 'zakova', 'zakova.jpg', 'D 119', '742', 'OIKR', 'teacher', 'zástupca riaditeľa ústavu pre pedagogickú činnosť; zástupca vedúceho oddelenia', '', '', ''),
(41, 'Danica', 'Rosinová', 'doc. Ing.', ' PhD.', NULL, 'rosinova.jpg', 'D 111', '563', 'OIKR', 'teacher', 'vedúci oddelenia\r\n', '', '', ''),
(42, 'Admin', 'Admin', NULL, NULL, 'xdzacovsky', NULL, '', NULL, '', '', NULL, '', '', ''),
(43, 'Laravel', 'Laravel', 'Prof.', 'PhD.', 'xtrocha', NULL, '456', '123', 'ABC', 'developer', 'develop', '', '', ''),
(55, 'aaaa', 'aaa', 'aaaa', 'aaaa', 'xaaa', 'default_male_img.png', 'aaaa', 'aaaaa', 'AHU', 'doktorand', 'aaaaa', '', 'aaa@aaa', 'http://aaaa.com'),
(56, 'bbb', 'bbbová', 'bbb', 'bbb', 'xss', 'default_female_img.png', 'bbb', 'bbbbbb', 'AHU', 'doktorand', 'bbb', '[\"admin\"]', NULL, NULL);
...
INSERT INTO `video_gallery` (`v_id`, `title_SK`, `title_EN`, `url`, `type`) VALUES
...
--
ALTER TABLE `video_gallery`
  MODIFY `v_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;COMMIT;
